...
namespace Web_BanSach_ConnnectAPI.Models
{
    public class AccountsAPI
    {
        ...
        public List<Accounts> GetData()
        {
            ...
            HttpWebRequest WebReq1 = (HttpWebRequest)WebRequest.Create(string.Format("https://localhost:44303/api/Accounts/"));
            string http = "https://localhost:44303/";

            WebReq1.Method = "GET";

            HttpWebResponse WebResp = (HttpWebResponse)WebReq1.GetResponse();
